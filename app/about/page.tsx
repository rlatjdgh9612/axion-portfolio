  ...
  return (
    <>
      ...
      <section className="about-profile container">
        <Reveal className="about-figma-heading">
          <h1>
            안녕하세요!
            <br />
            AX 기획자 &amp; UX 디자이너 김성호 입니다
          </h1>
        </Reveal>
        <div className="about-figma-grid">
          <Reveal className="about-figma-copy">
            <div>
              <h2>자기 소개</h2>
              <p>서비스 기획과 프로덕트 디자인을 중심으로 다양한 산업의 기업들과 프로젝트를 수행해왔으며, 최근에는 AX Strategy를 활용한 AI 프로세스를 연구하고 실무에 적용하고 있습니다.</p>
            </div>
            <div>
              <h2>핵심 역량</h2>
              <ul>
                <li>사용자 문제 정의 기반 서비스 기획 &amp; Product Design 수행</li>
                <li>AI(Claude, Figma MCP) 활용 UX 기획 효율화 및 웹사이트 개발 구축</li>
                <li>금융·핀테크, 세무, 블록체인, 이커머스 등 다양한 도메인 UX 설계 경험</li>
                <li>Figma, Confluence, Slack 기반 PM·개발자 협업 커뮤니케이션</li>
              </ul>
            </div>
            <div>
              <h2>핵심 스킬</h2>
          ...
          <Reveal className="about-profile-image" delay={0.08}>
            <Image src="/assets/about/profile-main.png" alt="김성호 프로필" width={428} height={656} priority />
          </Reveal>
        </div>
      </section>
      <section className="about-process container">
        <Reveal>
          <h2>업무 프로세스</h2>
          <p>문제 정의부터 제품 고도화까지, AI &amp; AX 기반의 업무 프로세스를 소개합니다</p>
        </Reveal>
        <div className="process-list">
          {process.map((item, index) => (
            <Reveal className="process-row" key={item.step} delay={index * 0.06}>
