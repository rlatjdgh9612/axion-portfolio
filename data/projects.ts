...
export const projects: Project[] = [
  {
    ...
    period: "2026.07 ~ 진행중",
    role: "서비스 기획 & 디자인 (100%), AI 기반 프론트엔드 개발 (100%)",
    tools: "Figma, Figma MCP, Codex, Claude, Notion",
    team: "서비스 기획 & UX 디자인 & 개발자 (1명) (1인 프로젝트)",
    accent: "#02002c",
    device: "responsive",
  ...
  },
  {
    ...
    role: "서비스 고도화 & UX 리뉴얼 기획 (100%), App 디자인 유지보수(50%)",
    tools: "Figma, Slack, Jira, Confluence",
    team: "서비스 기획(1명), iOS & AOS 개발자(각 1명), 백엔드 개발자(1명), 디자인 디렉터(1명), CTO(2명)",
    accent: "#ff6a00",
    device: "mobile",
  ...
  },
  {
    ...
    role: "UX/UI 리디자인 (100%)",
    tools: "Figma, Slack",
    team: "UXUI 디자이너(1명), 프론트엔드 개발자(2명), 백엔드 개발자(1명), CTO(1명)",
    accent: "#121826",
    device: "desktop",
  ...
  },
  {
    ...
    role: "서비스 기획 (100%), UX/UI 디자인 (100%)",
    tools: "Figma, Slack",
    team: "서비스 기획 & UXUI 디자이너(1명), 프론트엔드 개발자(1명), CTO(1명)",
    accent: "#d82222",
    device: "desktop",
  ...
  },
  {
    ...
    role: "WEB 서비스 기획 (100%), UX/UI 디자인 (100%)",
    tools: "Figma, Google Gemini",
    team: "UXUI 디자이너(1명), 프론트엔드 & 백엔드 개발자(1명)",
    accent: "#111111",
    device: "responsive",
  ...
  },
  {
    ...
    role: "WEB 서비스 기획 (50%), UX/UI 디자인 (100%)",
    tools: "Figma, Notion",
    team: "UXUI 디자이너(1명), 프론트엔드 & 백엔드 개발자(1명)",
    accent: "#d94f55",
    device: "responsive",
  ...
  },
  {
    ...
    role: "UX/UI 디자인 (100%)",
    tools: "Figma, Notion, Slack, Google Workspace",
    team: "UXUI 디자이너(1명), 프로젝트 리드(1명), 프론트엔드 & 백엔드 개발자(각 1명), PM(1명)",
    accent: "#3c3cfa",
    device: "desktop",
