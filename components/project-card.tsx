...
export function ProjectCard({ project, priority = false, analyticsLocation = "projects_index" }: { project: Project; priority?: boolean; analyticsLocation?: string }) {
  ...
  return (
    <article className="project-card">
      ...
      <Link href={`/projects/detail/${project.slug}`} className="project-visual" aria-label={`${project.title} 프로젝트 상세 보기`} style={{ "--project-accent": project.accent } as React.CSSProperties} data-analytics-event="project_card_click" data-analytics-project-slug={project.slug} data-analytics-project-category={project.category} data-analytics-location={analyticsLocation}>
        {project.image ? <>
