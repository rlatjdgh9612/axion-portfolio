...
Figma에서 완성한 반응형 화면과 디자인 시스템을 Next.js 기반 웹사이트로 구현해 실제 프로젝트 탐색 경험을 제공할 예정입니다.

웹사이트는 준비중 입니다(8월 초 예정)

## 포트폴리오 포지셔닝

서비스 기획과 프로덕트 디자인을 중심으로 그동안 수행했던 금융, 핀테크, 블록체인, 세무·회계, M&A, 안전 인프라, 브랜딩 분야의 고객사 프로젝트들을 하나로 모아서 보여줍니다.
