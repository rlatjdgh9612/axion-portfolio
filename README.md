...
AXION은 서비스 기획과 UX/UI Design 프로젝트를 체계적으로 정리하고, 기획부터 디자인까지의 문제 해결 과정과 결과물을 효과적으로 전달하기 위해 제작한 기획자 & 디자이너 포트폴리오 웹사이트입니다.
...
AXION은 사용자의 문제를 이해하고 더 나은 서비스 경험으로 연결하는 **서비스 기획자 & UX 디자이너 김성호의 실무 포트폴리오**입니다.

서비스 기획과 프로덕트 디자인을 중심으로 그동안 수행했던 금융, 핀테크, 블록체인, 세무·회계, M&A, 안전 인프라, 브랜딩 분야의 고객사 프로젝트들을 하나로 모아서 보여주는 포트폴리오 웹사이트 입니다.
