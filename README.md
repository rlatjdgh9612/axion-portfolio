...
<!-- GA4_METRICS_START -->
> 최근 30일 집계 · 마지막 자동 업데이트: 2026-08-11-10:03 KST
...
<sub>GA4의 익명 집계값이며 개인 식별 정보는 수집하거나 저장소에 기록하지 않습니다. 프로젝트 카드 클릭률은 0.0%, 이력서 다운로드율은 0.0%입니다.</sub>
<!-- GA4_METRICS_END -->
...
**현재 버전: `v1.1.1` — 비공개 이력서 다운로드 전환 버전**

| 버전 | 반영일 | 단계 | 주요 범위 |
| --- | --- | --- | --- |
| `v1.1.1` | 2026-08-14 | 이력서 다운로드 보안 | 비공개 저장소 기반 최신 이력서 다운로드로 전환하고 운영 배포를 검증 |
| `v1.1.0` | 2026-08-10 | 성과 측정 자동화 | GA4 이벤트·GitHub UTM 측정과 최근 30일 README 자동 리포트 구축 |
| `v1.0.0` | 2026-08-09 | 제출 버전 | Vercel 배포·접근성·상세 이미지 정합성을 보완하고 전체 QA 완료 |
| `v0.11.1` | 2026-08-06 | 모바일 레이아웃 보정 | 390px 모바일 레이아웃·CTA·로고·메타데이터·탭 동작 보정 |
| `v0.11.0` | 2026-08-05 | 미사용 코드 · CSS 정리 | 미사용 구현·CSS 113개 제거와 상세 경로·코드 리뷰 구조 정리 |
| `v0.10.0` | 2026-08-05 | 상세 Figma 프레임 전환 | 9개 상세 페이지를 Figma Light·Dark 프레임 기반으로 전환 |
| `v0.9.x` | 2026-08-03 | 상세 페이지 완성 | 9개 상세 페이지의 기획·IA·주요 화면·디자인 시스템 구현 |
| `v0.6.0` | 2026-08-03 | QA · 오류 수정 자동화 | 반응형·테마 QA와 GitHub Actions 품질 검증 자동화 구축 |
| `v0.1.0` | 2026-07-27 | 기획 · 디자인 명세 | PRD·IA·반응형 화면·디자인 시스템·AX 작업 흐름 정의 |
| — | 2026-07-02 ~ 2026-08-03 | Figma 디자인 작업 | Light·Dark 전 화면과 공통 디자인 시스템·컴포넌트 구축 |
| — | 2026-07-01 | 기획 작업 | 서비스 방향·타깃 독자·IA·사용자 흐름·콘텐츠 구조 정의 |
