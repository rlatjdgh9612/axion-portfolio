...
| `v0.11.1` | 2026-08-06 | 모바일 레이아웃 보정 | 390px 기준 홈 하단 키워드 2×2 배치와 고객사 로고 2열 카드 전환, 프로젝트 더 보기 버튼 하단 이동, 프로젝트 페이지 히어로 공백 축소, 연락 섹션 문구·크기 정리, 푸터 로고 확대 및 좌측 정렬, 소개 프로필 이미지 하단 정렬 |
